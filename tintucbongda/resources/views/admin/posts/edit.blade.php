        ...
        <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="trang_thai" name="trang_thai">
                    <option value="Chờ duyệt" {{ old('trang_thai', $post->trang_thai) == 'Chờ duyệt' ? 'selected' : '' }}>Chờ duyệt</option>
                    <option value="Đã duyệt" {{ old('trang_thai', $post->trang_thai) == 'Đã duyệt' ? 'selected' : '' }}>Đã duyệt</option>
                    <option value="Từ chối" {{ old('trang_thai', $post->trang_thai) == 'Từ chối' ? 'selected' : '' }}>Từ chối</option>
                    <option value="Nháp" {{ old('trang_thai', $post->trang_thai) == 'Nháp' ? 'selected' : '' }}>Nháp</option>
                </select>
                <small class="text-muted">Chọn trạng thái bài viết</small>
            </div>
