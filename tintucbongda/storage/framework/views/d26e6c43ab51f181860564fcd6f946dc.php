                ...
                <?php $__currentLoopData = $featuredArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6 col-12 d-flex">
                        <div class="border-0 shadow card featured-card flex-fill position-relative">
                            <div class="featured-img position-relative w-100" style="background-image: url('<?php echo e(asset($article['anh_dai_dien'])); ?>');">
                                <a href="<?php echo e(route('bai-viet.show', $article->id)); ?>" class="dis-block how1-child1 trans-03 w-100 h-100"></a>
                            ...
                            <div class="card-body d-flex flex-column">
                                <div class="flex-wrap mb-2 d-flex align-items-center">
                                    <span class="mb-1 badge bg-primary me-2"><?php echo e($article->danhMuc->ten_danh_muc ?? 'Chưa phân loại'); ?></span>
                                    <span class="mb-1 text-muted small ms-auto"><i class="fa fa-user me-1"></i><?php echo e($article->user->ho_ten ?? 'Ẩn danh'); ?></span>
                                </div>
                                <h5 class="mb-2 card-title">
                                    <a href="<?php echo e(route('bai-viet.show', $article->id)); ?>" class="tieu_de text-decoration-none fw-bold text-dark hov-cl10">
                                        <?php echo e($article['tieu_de']); ?>

                                    </a>
                                </h5>
                                <p class="mb-0 card-text text-secondary flex-grow-1">
                                    <?php echo e(Str::limit(strip_tags($article['noi_dung']), 120)); ?>

                                </p>
                            </div>
                            <div class="bg-white border-0 card-footer text-end">
                                <span class="text-muted small"><i class="fa fa-calendar me-1"></i><?php echo e(optional($article->created_at)->format('d/m/Y')); ?></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row p-t-35">
                    <?php $__currentLoopData = $latestArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-sm-6 col-md-4">
                            <div class="m-b-45">
                                <a href="<?php echo e(route('bai-viet.show', $article->id)); ?>" class="wrap-pic-w hov1 trans-03">
                                    <img src="<?php echo e(asset($article['anh_dai_dien'])); ?>" alt="IMG">
                                </a>

                                <div class="p-t-16">
                                    <h5 class="p-b-5">
                                        <a href="<?php echo e(route('bai-viet.show', $article->id)); ?>" class="f1-m-3 cl2 hov-cl10 trans-03">
                                            <?php echo e($article['tieu_de']); ?>
                                    ...
                                    <span class="cl8">
                                        <span class="f1-s-4 cl8 hov-cl10 trans-03">
                                            <?php echo e($article->user->ho_ten ?? 'Ẩn danh'); ?>
                                        ...
                                        <span class="f1-s-3">
                                            <?php echo e(optional($article->created_at)->format('d/m/Y')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DoAnWEB\QLDA_WebTheThao_Nhom03\tintucbongda\resources\views/home.blade.php ENDPATH**/ ?>